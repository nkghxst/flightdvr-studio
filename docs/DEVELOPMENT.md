...
The shared operating agreement is in [AGENTS.md](../AGENTS.md). Use
[WORKFLOW.md](WORKFLOW.md) for current collaboration, publication, review and
evidence procedure, and [AGENT_LESSONS.md](AGENT_LESSONS.md) for the compact
incident index. The notes below stay technical: they explain source ownership,
measured behaviour and platform constraints rather than repeating chat rules.
